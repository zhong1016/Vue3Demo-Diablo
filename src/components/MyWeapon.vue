  ...
  <section class="container">
    <div class="row">
      ...
      >
        ...
        >
        <router-link to="/Vue3Demo-Diablo/shield"
          ><button class="d2btn">盾牌<span>符文</span></button></router-link
        >
      </div>
    </div>
    <table class="container">
      ...
      >
        <td class="armor-td col-4 col-lg-6">
          ...
          >{{ item.ruenmixen[5]
          }}<span style="height: 0" class="d-flex d-lg-none"><br /></span><br />
          需求等级 : {{ item.level }}
        </td>
        <td
...
let i = 0;
axios
  .get("https://zhong1016.github.io/Vue3Demo-Diablo/assets/Weapon.json")
  // .get("src/json/Weapon.json")
  .then((res) => {
